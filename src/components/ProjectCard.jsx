...
const ProjectCard = ({ project }) => {
  return (
    <article className=' border border-neutral-dark dark:border-neutral-light rounded-xl shadow-md hover:shadow-2xl dark:hover:shadow-lg transition-all duration-300 dark:hover:shadow-accent-dark hover:scale-[1.005] ease-in-out'>
      <img 
