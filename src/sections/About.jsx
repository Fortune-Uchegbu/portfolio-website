    ...
    <section id="about">
      <Wrapper classes={`flex flex-col text-medium lg:text-xl items-center gap-y-10 ${paddings.secheight}`}>
        ...
        <div className={width < 1024 ? 'flex flex-col items-center' : ''}>
          ...
          <p className="text-start lg:mb-8 aboutMe">
          ...
          <p className="text-start lg:mb-8 whatIDo">
          ...
          <p className="text-start lg:mb-8 whatI'mOnCurrenlty">
          ...
          <p className="text-start lg:mb-8 whyIBuild">
          ...
          <p className="text-start lg:mb-8 whatI'mLookingFor">
